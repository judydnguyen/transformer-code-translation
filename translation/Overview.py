...
# 3. pip install streamlit_code_editor
# 4. pip install requests
# 5. pip install torch
# 6. pip install transformers
# 7. streamlit run Overview.py
...
st.markdown('<div class="custom-text">Pre-trained models for programming language have achieved dramatic empirical improvements on a variety of code-related tasks such as code search, code completion, code summarization, etc. However, existing pre-trained models regard a code snippet as a sequence of tokens, while ignoring the inherent structure of code, which provides crucial code semantics and would enhance the code understanding process.</div>', unsafe_allow_html=True)

st.divider()

st.markdown('<div class="custom-text">In this demo, we demonstrate the ability of the model to translate a chunk of Java code to C# when incorporating information about the code snippet\'s control flow graph to improve model performance.</div>', unsafe_allow_html=True)
